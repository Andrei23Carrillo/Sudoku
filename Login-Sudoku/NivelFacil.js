...
function iniciar_juego_primera_vez_2()
{
    ...
    alert('Bienvenido al Sudoku.\nTe recomiendo que leer las reglas primero por que estas por empezar el nivel Facil\'.');
...
function validar_sudoku_usuario()
{
    ...
    {
        var sudoku_valido = validar_sudoku(true);
        if (sudoku_valido) { alert("El sudoku ES CORRECTO. Enhorabuena.");
        detenerReloj()} //Si es correcto, da la enhorabuena.
